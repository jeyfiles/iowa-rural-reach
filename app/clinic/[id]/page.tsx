  ...
  if (!clinic) {
    return (
      <div style={{ minHeight: "100vh", display: "flex",
        ...
        fontFamily: F.body, color: C.t3 }}>
        <div style={{ textAlign: "center" }}>
          <div style={{ fontFamily: F.heading, fontSize: 28,
            color: C.iBlue, marginBottom: 12 }}>
            Clinic not found
          </div>
          <button onClick={() => router.push("/results")}
            style={{ background: C.iBlue, color: C.iWhite,
              border: "none", borderRadius: 4, padding: "12px 24px",
              fontFamily: F.heading, fontSize: 16,
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              ...
              {clinic.telehealth && (
                <span style={{ display: "inline-flex", alignItems: "center",
                  gap: 5, fontSize: 13, fontFamily: F.body, fontWeight: 500,
              ...
              {clinic.sliding && (
                <span style={{ fontSize: 13, fontFamily: F.body,
                  fontWeight: 500, color: "#166534", background: "#DCFCE7",
                  padding: "4px 12px", borderRadius: 4 }}>
              ...
              {clinic.type === "veteran" && (
                <span style={{ display: "inline-flex", alignItems: "center",
                  gap: 5, fontSize: 13, fontFamily: F.body, fontWeight: 500,
                  color: "#7A5E00", background: C.goldL,
                  padding: "4px 12px", borderRadius: 4 }}>
                  <IconShield />
          ...
          <div style={{ display: "flex", gap: 12,
            ...
            <a href={"tel:" + clinic.phone}
              ...
              <button style={{ width: "100%",
                ...
                borderRadius: 4, background: C.iBlue,
                color: C.iWhite, border: "none",
            ...
            <a href={"https://maps.google.com/?q=" + encodeURIComponent(clinic.address)}
              ...
              <button style={{ width: "100%",
                ...
                justifyContent: "center", gap: 10,
                padding: isMobile ? "13px 20px" : "13px 28px",
                borderRadius: 4, background: C.iWhite,
                color: C.iBlue,
          ...
          {tabs.map(tab => (
            <button key={tab.id}
              ...
              style={{ padding: isMobile ? "12px 16px" : "14px 24px",
                ...
                cursor: "pointer", color: activeTab === tab.id ? C.iBlue : C.t3,
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ background: C.iWhite, borderRadius: 6,
              ...
              <div style={{ display: "flex", gap: 10,
                ...
                <span style={{ color: C.iBlue, flexShrink: 0, marginTop: 2 }}>
                  <IconMap />
                </span>
                <div>
                ...
                <div>
                  ...
                  <div style={{ fontFamily: F.body,
                    ...
                    {lang === "en"
                      ...
                      : "Sabado: 9:00 AM – 12:00 PM · Domingo: Cerrado"}
                  </div>
                </div>
              </div>
            </div>
                ...
                {clinic.services.map(svc => (
                  <span key={svc}
                    style={{ display: "inline-flex", alignItems: "center",
                      gap: 6, fontFamily: F.body,
                      fontSize: isMobile ? 13 : 14,
                      color: C.iBlue, background: C.blueL,
                      padding: "6px 14px", borderRadius: 4,
                      fontWeight: 500 }}>
                    <span style={{ color: C.iBlue }}><IconCheck /></span>
                    {svc}
                  </span>
                ))}
              </div>
                ...
                <div>
                  ...
                  <div style={{ fontFamily: F.body,
                    ...
                    {lang === "en"
                      ...
                      : "Puede programar una cita virtual con esta clinica. No necesita manejar — reunase con un proveedor desde su telefono o computadora."}
                  </div>
                </div>
              </div>
            )}
            ...
            {clinic.sliding && (
              <div style={{ background: "#DCFCE7", borderRadius: 6,
                ...
                <div style={{ fontFamily: F.heading, fontSize: 17,
                  ...
                  {lang === "en"
                    ? "No Insurance? You Still Qualify"
                    : "Sin Seguro? Aun Califica"}
                </div>
                <div style={{ fontFamily: F.body,
                  fontSize: isMobile ? 14 : 15,
                  ...
                  {lang === "en"
                    ...
                    : "Esta clinica usa un sistema de tarifas de escala movil. Usted paga segun su nivel de ingresos, incluso si no tiene seguro en absoluto. No se rechaza a nadie por falta de pago."}
                </div>
              </div>
            )}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10,
              ...
              <div style={{ fontFamily: F.body,
                ...
                {lang === "en"
                  ...
                  : "Lista de preparación según este tipo de clínica. Confirme siempre los detalles directamente con la clínica."}
              </div>
            </div>
                  ...
                  {prep.bring.map((item, i) => (
                    <div key={i} style={{ display: "flex",
                      ...
                      <div style={{ width: 22, height: 22, borderRadius: 4,
                        background: C.blueL, flexShrink: 0,
                        display: "flex", alignItems: "center",
                        justifyContent: "center", color: C.iBlue,
                        marginTop: 1 }}>
                        <IconCheck />
                      </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  {prep.ask.map((q, i) => (
                    <div key={i} style={{ display: "flex",
                      alignItems: "flex-start", gap: 10 }}>
                      <div style={{ width: 22, height: 22, borderRadius: 4,
                        background: C.goldL, flexShrink: 0,
                        display: "flex", alignItems: "center",
                        justifyContent: "center",
                        fontFamily: F.heading, fontSize: 12,
                        fontWeight: 700, color: "#7A5E00",
                        marginTop: 1 }}>
                        ?
                      </div>
                      <span style={{ fontFamily: F.body,
